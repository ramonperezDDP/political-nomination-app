# PLAN: Persistent Title Bar with Logo and District
...
const ROUND_LABELS: Record<string, string> = {
  pre_nomination: 'Pre-Nomination',
  nomination: 'Endorsement',
  virtual_town_hall: 'Virtual Town Hall & Debate',
...
export default function AppHeader() {
  ...
  const contestStage = partyConfig?.contestStage || 'nomination';
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.surface }]}>
      ...
      <View style={styles.roundContainer}>
        <Text variant="labelSmall" style={{ color: theme.colors.outline }}>
          {ROUND_LABELS[contestStage] || contestStage}
        </Text>
      </View>
...
- Verify round label updates based on `partyConfig.contestStage`
