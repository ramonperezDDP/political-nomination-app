...
// Calculate alignment score based on matching issues and spectrum positions
const calculateAlignmentScore = (
  ...
  matchedIssues.forEach((issueId) => {
    ...
    if (candidatePosition) {
      // Higher bonus for issues the candidate also prioritizes highly (priority 1-3)
  ...
  // - 20 base points
  // - Up to 50 points for overlap ratio (50% of score)
